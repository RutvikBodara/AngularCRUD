        ...
        if (result.code == 106) {
          ...
          if (this.excelDownLoadStatus) {
            ...
            const docDefinition = {
              ...
              pageMargins: [40, 60, 40, 60],  // Adjust margins to ensure the border is visible
                      ...
                      canvas: [
                          {
                              ...
                              x: 20,
                              y: 20,
                              w: pageSize.width - 40,  // Subtract 40px total (20px on each side)
                              h: pageSize.height - 40,
                              lineWidth: 2,  // Border thickness
                              lineColor: '#000000'  // Border color (black)
                          }
                      ]
                  };
              }
